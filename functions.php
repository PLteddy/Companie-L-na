...
function add_script() {
  wp_enqueue_script('test-js', get_template_directory_uri() . '/test.js', array(), false, true);
  wp_enqueue_script('swiper-js', get_template_directory_uri() . '/swiper.js', array(), false, true);
  wp_enqueue_script('main-js', get_template_directory_uri() . '/main.js', array('swiper-js'), false, true);
}
